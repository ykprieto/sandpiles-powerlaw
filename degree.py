...
#Add a new file similitudes_"pts"pts.txt
#===============================================================================
import sys
...
def grafica_all_sizes(x_50,x_100,x_200,x_300,x_500,x_1000,y_50,y_100,y_200,y_300,y_500,y_1000,case):
	...
	plt.xticks(dominio)
	if case==0:		#case=0 is MINIMAL DEGREE
		plt.savefig("./minimalDegree.pdf")
	else:			#other case is MEAN DEGREE
		plt.savefig("./meanDegree.pdf")
	plt.show()
	plt.close()
#----------------------------------------------------------------------------------------------------
#Dominio Ptos,minimal_degree,mean_degree
X_50=Leer_archivo("./Degree.txt",50,1) 			#PUNTOS
X2_50=Leer_archivo("./Degree.txt",50,2)			#MINIMAL_DEGREE
X3_50=Leer_archivo("./Degree.txt",50,3)			#MEAN_DEGREE

X_100=Leer_archivo("./Degree.txt",100,1)
X2_100=Leer_archivo("./Degree.txt",100,2)
X3_100=Leer_archivo("./Degree.txt",100,3)

X_200=Leer_archivo("./Degree.txt",200,1)
X2_200=Leer_archivo("./Degree.txt",200,2)
X3_200=Leer_archivo("./Degree.txt",200,3)

X_300=Leer_archivo("./Degree.txt",300,1)
X2_300=Leer_archivo("./Degree.txt",300,2)
X3_300=Leer_archivo("./Degree.txt",300,3)

X_500=Leer_archivo("./Degree.txt",500,1)
X2_500=Leer_archivo("./Degree.txt",500,2)
X3_500=Leer_archivo("./Degree.txt",500,3)

X_1000=Leer_archivo("./Degree.txt",1000,1)
X2_1000=Leer_archivo("./Degree.txt",1000,2)
X3_1000=Leer_archivo("./Degree.txt",1000,3)

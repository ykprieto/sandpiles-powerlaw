...
void writeout(int num_ptos,int num,int varRandom, int argc, char **argv)
{
    ...
    std::string ruta = "";
    ruta="/home/ykprieto/Dropbox/Algoritmos/Algoritmos_principales/imagenes_Tropical/grid_"+static_cast<std::ostringstream*>(&(std::ostringstream() << num_ptos))->str()+ "pts_"+static_cast<std::ostringstream*>(&(std::ostringstream() << num))->str() + "size_"+ static_cast<std::ostringstream*>(&(std::ostringstream() << varRandom))->str()+"_experiment.dat";
    string path(ruta);
    ...
    path = "/home/ykprieto/Dropbox/Algoritmos/Algoritmos_principales/pruebita/psequence"+static_cast<std::ostringstream*>(&(std::ostringstream() << num_ptos))->str()+ "pts_"+static_cast<std::ostringstream*>(&(std::ostringstream() << num))->str() + "size_"+ static_cast<std::ostringstream*>(&(std::ostringstream() << varRandom))->str()+"_experiment.dat";
    ...
    path = "/home/ykprieto/Dropbox/Algoritmos/Algoritmos_principales/pruebita/active"+static_cast<std::ostringstream*>(&(std::ostringstream() << num_ptos))->str()+ "pts_"+static_cast<std::ostringstream*>(&(std::ostringstream() << num))->str() + "size_"+ static_cast<std::ostringstream*>(&(std::ostringstream() << varRandom))->str()+"_experiment.dat";

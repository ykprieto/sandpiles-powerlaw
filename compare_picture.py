...
# Input       : python compare_picture.py size pts seed
#==============REMARKS==========================================================
...
im1 = ruta+"/images_trop/grid_"+pts+"pts_"+size+"size_"+seed+"_experiment.dat"
im2 = ruta+"/images_sand/gridSand_"+pts+"pts_"+size+"size_"+seed+"_experiment.dat"
...
def similitud_images(c1,c2):				#REMARK:LA MATRIZ QUE ARROJA ES LA TRANSPUESTA A LA ASOC A LA IMAGEN. 1:COINCIDEN 0:NO COINCIDE.
	...
	archi=open(ruta+"/similitudes_"+pts+"pts.txt",'a')
...
#=COMPARE BOTH MODELS IN A SET OF EXPERIMENTS >1 =============================================
...
#Analisis size UNCOMMENT THE NEXT LINES:

#v_percentage=Leer_archivo(ruta+"/similitudes_"+pts+"pts.txt") 

...
{
    std::string ruta = "";
    ruta="/home/ykprieto/Dropbox/Algoritmos/Algoritmos_principales/imagenes_Sandpiles/gridSand_"+static_cast<std::ostringstream*>(&(std::ostringstream() << num_ptos))->str()+ "pts_"+static_cast<std::ostringstream*>(&(std::ostringstream() << num))->str() + "size_"+ static_cast<std::ostringstream*>(&(std::ostringstream() << varRandom))->str()+"_experiment.dat";
    string path(ruta);

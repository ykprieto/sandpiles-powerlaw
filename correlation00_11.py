...
#----------------------------------------------------------------------------------------------------
def function_0011(s,vector_average,vector_average2):		
	yPointR=[]	
	...
	return yPointR
#----------------------------------------------------------------------------------------------------
def function_Log0011(s,vector_average,vector_average2):	
	yPointR=[]	
...
def grafica_all_sizes(xPoint,y_50,y_100,y_200,y_300,y_500,y_1000,case):
	...
	plt.xticks(dominio)
	if case==0:		#case=0 is normal
		plt.savefig("./f0011.pdf",bbox_inches='tight', pad_inches=0)
	else:			#other case is log function
		plt.savefig("./f0011corr.pdf",bbox_inches='tight', pad_inches=0)
	plt.show()
	plt.close()
